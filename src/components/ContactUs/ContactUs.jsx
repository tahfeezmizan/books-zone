...
const ContactUs = () => {
    return (
        <div className="w-full px-4 md:px-0 md:w-8/12 mx-auto">
            <div className="text-center border-y-2 py-9 border-dotted mb-8">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 xl:gap-6 mb-12 justify-between items-center">
                ...
                <div className="address-bar col-span-11 xl:col-span-5 p-5 md:p-10 border-2 rounded-xl">
                    ...
                    <div className="email py-10 px-8 rounded-2xl mb-6 bg-yellow-300 bg-opacity-10">
                        ...
                        <h4 className="text-black text-lg font-extrabold">hockeys@support.com</h4>
                    </div>
                    <div className="location py-10 px-8 rounded-2xl bg-blue-400 bg-opacity-10">
                        ...
                        <h4 className="text-black text-lg font-extrabold">152/1 Mohakhali Wireless Gate</h4>
                    </div>
                </div>


                <div className="contact-from col-span-11 xl:col-span-7">
                    ...
                    <button
                        className="btn border-none rounded-8 w-full bg-red-500 text-white text-xl font-semibold hover:bg-red-600">Send
                        Message</button>
                </div>
            </div>
